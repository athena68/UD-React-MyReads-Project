...
const MainPage = () => {
  return (
    <div className="main-page">
      <BookShelf title="Want To Read" books={wantToReadBookData} />
      <BookShelf title="Reading" books={readingBookData} />
      <BookShelf title="Read" books={readBookData} />
